...
export const personalConfig = {
  ...
  emoji: "👋",
  description: `
  I currently work as a Lead Steering Engineer at [Cal Sol](https://calsol.berkeley.edu/), on [Excalibur](https://calsol.berkeley.edu/vehicles/) and new Gen 11 Vehicle.
